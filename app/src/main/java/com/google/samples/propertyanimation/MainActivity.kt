...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     private fun ObjectAnimator.disableViewRotation(view: View){
    ...
    private fun rotater() {
        ...
        animator.disableViewRotation(rotateButton)
        animator.start()
    }
    ...
    private fun translater() {
        ...
        animator.disableViewRotation(translateButton)
        animator.start()
    }
    ...
    private fun scaler() {
        ...
        animator.repeatCount = 1
        animator.repeatMode = ObjectAnimator.REVERSE
        animator.disableViewRotation(scaleButton)
        animator.start()
    ...
    private fun fader() {
        ...
        animator.repeatMode = ObjectAnimator.REVERSE
        animator.repeatCount = 1
        animator.disableViewRotation(fadeButton)
        animator.start()
    }
    ...
    private fun colorizer() {
        ...
        animator.repeatCount = 1
        animator.repeatMode = ObjectAnimator.REVERSE
        animator.disableViewRotation(colorizeButton)
    ...
    private fun shower() {
        ...
        //Remove a view que saiu da tela
